...
Para obter mais informações, xref:task-scanning-file-shares.html[Verificar compartilhamentos de arquivos]consulte .

.Informações aprimoradas sobre o proprietário do arquivo
Agora você pode visualizar mais informações sobre os proprietários dos arquivos capturados na aba "Investigação". Ao visualizar os metadados de um arquivo na aba "Investigação", localize o proprietário do arquivo e selecione **Exibir detalhes** para ver o nome de usuário, o e-mail e o nome da conta SAM. Você também pode visualizar outros itens pertencentes a este usuário. Este recurso está disponível apenas para ambientes de trabalho com o Active Directory.

Para obter mais informações, xref:task-investigate-data.html[Investigue os dados armazenados em sua organização]consulte .
