...
Você pode priorizar as digitalizações mais importantes ---somente Mapeamento ou mapa e classificação. A capacidade de priorizar digitalizações permite garantir que as digitalizações de alta prioridade sejam concluídas primeiro.
